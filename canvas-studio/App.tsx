...
const App: React.FC = () => {
  ...
  const collaboration = useCollaboration({
    projectSlug,
    userName: localStorage.getItem('onelastai_user_name') || `Guest ${Math.random().toString(36).slice(2, 6)}`,
  ...
  // 🏗️ GENERATION HOOK - handleGenerate, handleConversationalChat, handleStartBuilding, handleChatMessage
  const { handleGenerate, handleStartBuilding, handleChatMessage } = useGeneration({
    genState,
    setGenState,
    selectedModel,
    selectedLanguage,
  ...
  // 🤖 UNIFIED AGENT HOOK - Handles all agent actions
  const { handleAgentMessage } = useAgent({
    genState,
    setGenState,
    selectedModel,
    conversationHistory,
