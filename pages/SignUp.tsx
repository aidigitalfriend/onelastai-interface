...
const SignUp: React.FC<SignUpProps> = ({ onClose, onSignUp, onSwitchToSignIn }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-3xl overflow-hidden shadow-2xl animate-fadeIn max-h-[90vh] overflow-y-auto">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Join OneLast AI and start building</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 text-green-500 focus:ring-green-500/20 focus:ring-2"
              />
